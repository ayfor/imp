module ApplicationHelper
  @@registered_button_styles = {
    ...
    rounded: 'rounded-full bg-leftovers-blue px-3.5 py-2 text-sm font-medium text-whitee shadow-sm hover:bg-leftovers-blue/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-leftovers-blue'
  }
